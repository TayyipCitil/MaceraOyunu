public abstract class Main {
    ...
    static Inventory shield=new Inventory("🛡️(kalkan)",0,10,20);
    static Inventory sword=new Inventory("🗡️(kılıç)",7,5,25);
    ...
    static CharOfHero merchant = new CharOfHero("👱‍(Tüccar)", 35, 5, 50,inventory,2);
    static CharOfHero infantry = new CharOfHero("👨‍🦱(Piyade)", 40, 6, 10,inventory,2);
    static CharOfHero archery = new CharOfHero("👨‍🦰(Okçu)", 35, 7, 20,inventory,1);
