public class Main {
    ...
    static CharOfHero merchant = new CharOfHero(inventory, 2, "👱‍(Tüccar)", 35, 5, 50);
    static CharOfHero infantry = new CharOfHero(inventory, 5, "👨‍🦱(Piyade)", 40, 6, 10);
    static CharOfHero archery = new CharOfHero(inventory, 1, "👨‍🦰(Okçu)", 35, 7, 20);
